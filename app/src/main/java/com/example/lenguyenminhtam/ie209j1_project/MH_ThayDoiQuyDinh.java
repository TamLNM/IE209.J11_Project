...
public class MH_ThayDoiQuyDinh extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Navigate to MH_ThayDoiThongTinLop
        btn_ThayDoiThongTinLop = findViewById(R.id.btn_ThayDoiThongTinLop);
        btn_ThayDoiThongTinLop.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    protected void initView1() {
        Intent intent = new Intent(this, MH_ThayDoiThongTinLop.class);
